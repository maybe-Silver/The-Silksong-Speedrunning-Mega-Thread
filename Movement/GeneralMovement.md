...
- [Air Pogos](/Movement/GeneralMovement.md#air-pogos)
- [Neutral Pogos / Pogo NILs / Pogo Lag canceling](/Movement/GeneralMovement.md#neutral-pogos--pogo-nils--pogo-lag-canceling)
...
>### Neutral Pogos / Pogo NILs / Pogo Lag canceling
>
>Further improvement on air pogos. By pogo-ing **without** a full jump and purposefully hitting the floor, you would usually be temporarily stunned. However, by going neutral (hence the name of this tech) by not inputting any left or right direction when hitting the floor, you remove the stun completely and can move again. To set up for another pogo, go neutral and repeat.  
...
>### Jump dashing
>The initial boost from using swift step is faster than the rest of swift step's movement, and so by starting a dash as often as possible, you get more speed than simply holding a dash. This works due to the fact the air dash cooldown is refreshed upon touching the floor. So, by repeatedly dashing in the air and landing as soon as possible, you can take advantage of the constantly refreshing dash and the initial boost it gives.
...
>Faster than jump dashing. By combining both the speed a pogo gives you, as well as the initial dash boost, you can move INCREDIBLY fast throughout Pharloom.  
...
>Useful for covering large areas of flat ground, but fairly niche in use cases, not often recommended as you want to save your silk for combat, and it is slow if done incorrectly.
>Simply adding a Clawline at the end of a pogo dash, and continuing to pogo dash as your Clawline ends, is ever so slightly faster than pogo dashing without it.
>
...
>Clawline > Pogo Dash (or just dash depending on preference) ... Repeat with a following Clawline if you have silk, or continue to pogo dash normally.  
